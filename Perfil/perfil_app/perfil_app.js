...
function addPet (){
    ...
    let animalzin = document.getElementsByTag('td')
    
    console.log(animalzin[0],animalzin[1],animalzin[2],animalzin[3])
}
...
$(".maisinho").click(function(e){
    let maisinho = document.getElementsByClassName('maisinho')
    for (i=0; i <maisinho.length; i++){
    console.log('oie!')
    
    
    let fotoenomeanimais = document.getElementById('fotoenomeanimais')
    ...
    novafoto.setAttribute('src','camera-4-64.png')
    ...
    fotoenomeanimais.appendChild(novoanimal)
